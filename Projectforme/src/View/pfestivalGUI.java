...
public class pfestivalGUI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pfestivalGUI window = new pfestivalGUI();
	...
	private void initialize() {
		...
		JButton button = new JButton("\uC9C4\uD589\uC911\uC778 \uCD95\uC81C");
		button.setFont(new Font("HY¿±¼­M", Font.PLAIN, 18));
		button.setBounds(50, 242, 190, 23);
		frame.getContentPane().add(button);
		
		JButton button_1 = new JButton("\uC608\uC815\uC911\uC778 \uCD95\uC81C");
		button_1.setFont(new Font("HY¿±¼­M", Font.PLAIN, 18));
		button_1.setBounds(50, 371, 190, 23);
